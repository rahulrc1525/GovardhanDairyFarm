      ...
      <div className="cart-items">
        ...
        {Object.keys(cart).length > 0 ? (
          Object.entries(cart).map(([itemId, quantity]) => {
            ...
            if (!itemInfo) return null; // Skip if item not found

            return (
              <div key={itemId} className="cart-item">
                <img
                  src={itemInfo.image} // Use the full Cloudinary URL directly
                  alt={itemInfo.name}
      ...
      {Object.keys(cart).length > 0 && (
        <div className="cart-summary">
          ...
          <div className="summary-details">
            ...
            <p>
              Delivery Fee: <span className="summary-value">Rs. {deliveryFee}</span>
            </p>
